...
# Make the backend package importable when Alembic is invoked from any directory.
...
# Reuse the application's model metadata and database engine.  This keeps
# Alembic aligned with the application's single SQLAlchemy configuration.
